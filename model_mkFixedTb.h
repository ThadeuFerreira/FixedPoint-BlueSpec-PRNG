...
#ifndef __model_mkFixedTb_h__
#define __model_mkFixedTb_h__
...
/* Class declaration for a model of mkFixedTb */
class MODEL_mkFixedTb : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkFixedTb *mkFixedTb_instance;
...
extern "C" {
  void * new_MODEL_mkFixedTb();
}

#endif /* ifndef __model_mkFixedTb_h__ */
